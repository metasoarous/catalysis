...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__61556__auto__,writer__61557__auto__,opt__61558__auto__){
return cljs.core._write.call(null,writer__61557__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__63917 = o;
(G__63917[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
return (function() { 
var G__63918__delegate = function (args){
return cljs.core.apply.call(null,x,args);
};
var G__63918 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__63919__i = 0, G__63919__a = new Array(arguments.length -  0);
while (G__63919__i < G__63919__a.length) {G__63919__a[G__63919__i] = arguments[G__63919__i + 0]; ++G__63919__i;}
  args = new cljs.core.IndexedSeq(G__63919__a,0,null);
} 
return G__63918__delegate.call(this,args);};
G__63918.cljs$lang$maxFixedArity = 0;
G__63918.cljs$lang$applyTo = (function (arglist__63920){
var args = cljs.core.seq(arglist__63920);
return G__63918__delegate(args);
});
G__63918.cljs$core$IFn$_invoke$arity$variadic = G__63918__delegate;
return G__63918;
})()
;
} else {
...
if(cljs.core.truth_((function (){var and__60887__auto__ = !((jsprops == null));
if(and__60887__auto__){
var and__60887__auto____$1 = jsprops.hasOwnProperty("onChange");
...
var G__63926 = jsprops;
(G__63926["defaultValue"] = value);

(G__63926["onChange"] = ((function (G__63926,v,value,on_change){
return (function (p1__63923_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__63923_SHARP_);
});})(G__63926,v,value,on_change))
);

(G__63926["ref"] = ((function (G__63926,v,value,on_change){
return (function (p1__63924_SHARP_){
return (this$["cljsInputElement"] = p1__63924_SHARP_);
});})(G__63926,v,value,on_change))
);
...
var vec__63933 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__63933,(0),null);
var id = cljs.core.nth.call(null,vec__63933,(1),null);
var class$ = cljs.core.nth.call(null,vec__63933,(2),null);
...
var jsprops = ({"argv": v});
var temp__6742__auto___63938 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__6742__auto___63938 == null)){
} else {
var key_63939 = temp__6742__auto___63938;
(jsprops["key"] = key_63939);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__63941 = (new reagent.impl.template.NativeWrapper());
(G__63941["name"] = c);
...
var len__62120__auto___63947 = arguments.length;
var i__62121__auto___63948 = (0);
while(true){
if((i__62121__auto___63948 < len__62120__auto___63947)){
args__62127__auto__.push((arguments[i__62121__auto___63948]));

var G__63949 = (i__62121__auto___63948 + (1));
i__62121__auto___63948 = G__63949;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__62128__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq63945){
var G__63946 = cljs.core.first.call(null,seq63945);
var seq63945__$1 = cljs.core.next.call(null,seq63945);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__63946,seq63945__$1);
});
...
break;
default:
var G__63953 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__63953;
continue;
...
var n__61920__auto___63956 = a.length;
var i_63957 = (0);
while(true){
if((i_63957 < n__61920__auto___63956)){
(a[i_63957] = reagent.impl.template.as_element.call(null,(a[i_63957])));

var G__63958 = (i_63957 + (1));
i_63957 = G__63958;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__61920__auto___63959 = a.length;
var i_63960 = (0);
while(true){
if((i_63960 < n__61920__auto___63959)){
var val_63961 = (a[i_63960]);
if((cljs.core.vector_QMARK_.call(null,val_63961)) && ((reagent.impl.template.key_from_vec.call(null,val_63961) == null))){
(o["no-key"] = true);
} else {
}

(a[i_63960] = reagent.impl.template.as_element.call(null,val_63961));

var G__63962 = (i_63960 + (1));
i_63960 = G__63962;
continue;
} else {
}
...
var ctx = ({});
var vec__63966 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__63966,(0),null);
var derefed = cljs.core.nth.call(null,vec__63966,(1),null);
...
var G__63970 = (cljs.core.count.call(null,argv) - first_child);
switch (G__63970) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__63970){
...
//# sourceMappingURL=template.js.map?rel=1506064171468