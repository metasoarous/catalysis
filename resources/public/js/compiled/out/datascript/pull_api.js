...
return cljs.core.assoc.call(null,frame,new cljs.core.Keyword(null,"eids","eids",1546550700),eids,new cljs.core.Keyword(null,"specs","specs",1426570741),cljs.core.seq.call(null,new cljs.core.Keyword(null,"attrs","attrs",-2090668713).cljs$core$IFn$_invoke$arity$1(pattern)),new cljs.core.Keyword(null,"wildcard?","wildcard?",-686044101),new cljs.core.Keyword(null,"wildcard?","wildcard?",-686044101).cljs$core$IFn$_invoke$arity$1(pattern),new cljs.core.Keyword(null,"kvps","kvps",65308317),cljs.core.transient$.call(null,cljs.core.PersistentArrayMap.EMPTY),new cljs.core.Keyword(null,"results","results",-1134170113),(function (){var G__65376 = new cljs.core.Keyword(null,"results","results",-1134170113).cljs$core$IFn$_invoke$arity$1(frame);
if(cljs.core.seq.call(null,kvps)){
return cljs.core.conj_BANG_.call(null,G__65376,kvps);
} else {
return G__65376;
}
})());
...
var map__65379 = rec;
var map__65379__$1 = ((((!((map__65379 == null)))?((((map__65379.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__65379.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__65379):map__65379);
var depth = cljs.core.get.call(null,map__65379__$1,new cljs.core.Keyword(null,"depth","depth",1768663640));
var seen = cljs.core.get.call(null,map__65379__$1,new cljs.core.Keyword(null,"seen","seen",-518999789));
...
var G__65382 = new cljs.core.Keyword(null,"kvps","kvps",65308317).cljs$core$IFn$_invoke$arity$1(frame);
var G__65382__$1 = (((G__65382 == null))?null:cljs.core.persistent_BANG_.call(null,G__65382));
if((G__65382__$1 == null)){
return null;
} else {
return cljs.core.get.call(null,G__65382__$1,key);
}
});
...
datascript.pull_api.pull_recursion_frame = (function datascript$pull_api$pull_recursion_frame(db,p__65383){
var vec__65388 = p__65383;
var seq__65389 = cljs.core.seq.call(null,vec__65388);
var first__65390 = cljs.core.first.call(null,seq__65389);
var seq__65389__$1 = cljs.core.next.call(null,seq__65389);
var frame = first__65390;
var frames = seq__65389__$1;
...
var or__60899__auto__ = datascript.pull_api.pull_seen_eid.call(null,frame__$1,frames,eid);
...
var results = (function (){var G__65391 = new cljs.core.Keyword(null,"results","results",-1134170113).cljs$core$IFn$_invoke$arity$1(frame);
if(cljs.core.seq.call(null,kvps)){
return cljs.core.conj_BANG_.call(null,G__65391,kvps);
} else {
return G__65391;
}
})();
...
var recursion = cljs.core.get.call(null,map__65394__$1,new cljs.core.Keyword(null,"recursion","recursion",-749738765));
var pattern = cljs.core.get.call(null,map__65394__$1,new cljs.core.Keyword(null,"pattern","pattern",242135423));
...
var pattern_65396 = (new datascript.pull_parser.PullSpec(true,cljs.core.PersistentArrayMap.EMPTY,null,null,null));
datascript.pull_api.expand_frame = ((function (pattern_65396){
...
return cljs.core.assoc.call(null,datascript.pull_api.subpattern_frame.call(null,pattern_65396,eids,multi_QMARK_,attr_key),new cljs.core.Keyword(null,"recursion","recursion",-749738765),rec);
});})(pattern_65396))
;
datascript.pull_api.pull_attr_datoms = (function datascript$pull_api$pull_attr_datoms(db,attr_key,attr,eid,forward_QMARK_,datoms,opts,p__65398){
var vec__65406 = p__65398;
var seq__65407 = cljs.core.seq.call(null,vec__65406);
var first__65408 = cljs.core.first.call(null,seq__65407);
var seq__65407__$1 = cljs.core.next.call(null,seq__65407);
var parent = first__65408;
var frames = seq__65407__$1;
...
var found = cljs.core.not_empty.call(null,(function (){var G__65409 = datoms;
if(cljs.core.truth_(limit)){
return cljs.core.into.call(null,cljs.core.PersistentVector.EMPTY,cljs.core.take.call(null,limit),G__65409);
} else {
return G__65409;
}
})());
...
var datom_val = (cljs.core.truth_(forward_QMARK_)?((function (ref_QMARK_,component_QMARK_,multi_QMARK_,limit,found,vec__65406,seq__65407,first__65408,seq__65407__$1,parent,frames){
return (function (d){
return d.v;
});})(ref_QMARK_,component_QMARK_,multi_QMARK_,limit,found,vec__65406,seq__65407,first__65408,seq__65407__$1,parent,frames))
:((function (ref_QMARK_,component_QMARK_,multi_QMARK_,limit,found,vec__65406,seq__65407,first__65408,seq__65407__$1,parent,frames){
return (function (d){
return d.e;
});})(ref_QMARK_,component_QMARK_,multi_QMARK_,limit,found,vec__65406,seq__65407,first__65408,seq__65407__$1,parent,frames))
);
...
if(cljs.core.truth_((function (){var and__60887__auto__ = component_QMARK_;
...
var as_value = (function (){var G__65410 = datom_val;
if(ref_QMARK_){
return cljs.core.comp.call(null,((function (G__65410,ref_QMARK_,component_QMARK_,multi_QMARK_,datom_val,limit,found,vec__65406,seq__65407,first__65408,seq__65407__$1,parent,frames){
return (function (p1__65397_SHARP_){
return cljs.core.PersistentHashMap.fromArrays([new cljs.core.Keyword("db","id","db/id",-1388397098)],[p1__65397_SHARP_]);
});})(G__65410,ref_QMARK_,component_QMARK_,multi_QMARK_,datom_val,limit,found,vec__65406,seq__65407,first__65408,seq__65407__$1,parent,frames))
,G__65410);
} else {
return G__65410;
}
...
return cljs.core.conj.call(null,frames,cljs.core.update.call(null,parent,new cljs.core.Keyword(null,"kvps","kvps",65308317),cljs.core.assoc_BANG_,attr_key,(function (){var G__65411 = cljs.core.into.call(null,cljs.core.PersistentVector.EMPTY,cljs.core.map.call(null,as_value),found);
if(single_QMARK_){
return cljs.core.first.call(null,G__65411);
} else {
return G__65411;
}
})()));
...
return cljs.core.conj.call(null,frames,(function (){var G__65412 = parent;
if(cljs.core.contains_QMARK_.call(null,opts,new cljs.core.Keyword(null,"default","default",-1987822328))){
return cljs.core.update.call(null,G__65412,new cljs.core.Keyword(null,"kvps","kvps",65308317),cljs.core.assoc_BANG_,attr_key,new cljs.core.Keyword(null,"default","default",-1987822328).cljs$core$IFn$_invoke$arity$1(opts));
} else {
return G__65412;
}
})());
...
var vec__65416 = spec;
var attr_key = cljs.core.nth.call(null,vec__65416,(0),null);
var opts = cljs.core.nth.call(null,vec__65416,(1),null);
...
datascript.pull_api.filter_reverse_attrs = cljs.core.filter.call(null,(function (p__65419){
var vec__65420 = p__65419;
var k = cljs.core.nth.call(null,vec__65420,(0),null);
var v = cljs.core.nth.call(null,vec__65420,(1),null);
...
datascript.pull_api.pull_expand_reverse_frame = (function datascript$pull_api$pull_expand_reverse_frame(db,p__65423){
var vec__65427 = p__65423;
var seq__65428 = cljs.core.seq.call(null,vec__65427);
var first__65429 = cljs.core.first.call(null,seq__65428);
var seq__65428__$1 = cljs.core.next.call(null,seq__65428);
var frame = first__65429;
var frames = seq__65428__$1;
return datascript.pull_api.expand_result.call(null,frames,datascript.pull_api.into_BANG_.call(null,new cljs.core.Keyword(null,"expand-kvps","expand-kvps",44141154).cljs$core$IFn$_invoke$arity$1(frame),(function (){var or__60899__auto__ = datascript.pull_api.single_frame_result.call(null,new cljs.core.Keyword("datascript.pull-api","expand-rev","datascript.pull-api/expand-rev",2143627459),frame);
if(cljs.core.truth_(or__60899__auto__)){
return or__60899__auto__;
} else {
...
datascript.pull_api.pull_expand_frame = (function datascript$pull_api$pull_expand_frame(db,p__65430){
var vec__65437 = p__65430;
var seq__65438 = cljs.core.seq.call(null,vec__65437);
var first__65439 = cljs.core.first.call(null,seq__65438);
var seq__65438__$1 = cljs.core.next.call(null,seq__65438);
var frame = first__65439;
var frames = seq__65438__$1;
...
var vec__65440 = cljs.core.first.call(null,datoms_by_attr);
var attr = cljs.core.nth.call(null,vec__65440,(0),null);
var datoms = cljs.core.nth.call(null,vec__65440,(1),null);
...
var attr = cljs.core.get.call(null,map__65446__$1,new cljs.core.Keyword(null,"attr","attr",-604132353));
var recursion = cljs.core.get.call(null,map__65446__$1,new cljs.core.Keyword(null,"recursion","recursion",-749738765));
var rec = (function (){var G__65448 = recursion;
if(!((attr == null))){
return datascript.pull_api.push_recursion.call(null,G__65448,attr,eid);
} else {
return G__65448;
}
})();
...
var eid = cljs.core.get.call(null,map__65451__$1,new cljs.core.Keyword(null,"eid","eid",559519930));
var pattern = cljs.core.get.call(null,map__65451__$1,new cljs.core.Keyword(null,"pattern","pattern",242135423));
var or__60899__auto__ = datascript.pull_api.pull_seen_eid.call(null,frame,frames,eid);
if(cljs.core.truth_(or__60899__auto__)){
return or__60899__auto__;
} else {
...
datascript.pull_api.pull_pattern_frame = (function datascript$pull_api$pull_pattern_frame(db,p__65453){
while(true){
var vec__65457 = p__65453;
var seq__65458 = cljs.core.seq.call(null,vec__65457);
var first__65459 = cljs.core.first.call(null,seq__65458);
var seq__65458__$1 = cljs.core.next.call(null,seq__65458);
var frame = first__65459;
var frames = seq__65458__$1;
var temp__6736__auto__ = cljs.core.seq.call(null,new cljs.core.Keyword(null,"eids","eids",1546550700).cljs$core$IFn$_invoke$arity$1(frame));
if(temp__6736__auto__){
var eids = temp__6736__auto__;
...
var G__65460 = db;
var G__65461 = cljs.core.conj.call(null,frames,datascript.pull_api.reset_frame.call(null,frame,cljs.core.rest.call(null,eids),cljs.core.not_empty.call(null,cljs.core.persistent_BANG_.call(null,new cljs.core.Keyword(null,"kvps","kvps",65308317).cljs$core$IFn$_invoke$arity$1(frame)))));
db = G__65460;
p__65453 = G__65461;
continue;
}
...
while(true){
var G__65468 = new cljs.core.Keyword(null,"state","state",-1988618099).cljs$core$IFn$_invoke$arity$1(cljs.core.first.call(null,frames));
var G__65468__$1 = (((G__65468 instanceof cljs.core.Keyword))?G__65468.fqn:null);
switch (G__65468__$1) {
case "expand":
var G__65475 = db;
var G__65476 = datascript.pull_api.pull_expand_frame.call(null,db,frames);
db = G__65475;
frames = G__65476;
continue;
...
case "expand-rev":
var G__65477 = db;
var G__65478 = datascript.pull_api.pull_expand_reverse_frame.call(null,db,frames);
db = G__65477;
frames = G__65478;
continue;
...
case "pattern":
var G__65479 = db;
var G__65480 = datascript.pull_api.pull_pattern_frame.call(null,db,frames);
db = G__65479;
frames = G__65480;
continue;
...
case "recursion":
var G__65481 = db;
var G__65482 = datascript.pull_api.pull_recursion_frame.call(null,db,frames);
db = G__65481;
frames = G__65482;
continue;
...
break;
case "done":
var vec__65469 = frames;
var seq__65470 = cljs.core.seq.call(null,vec__65469);
var first__65471 = cljs.core.first.call(null,seq__65470);
var seq__65470__$1 = cljs.core.next.call(null,seq__65470);
var f = first__65471;
var remaining = seq__65470__$1;
var result = (function (){var G__65472 = cljs.core.persistent_BANG_.call(null,new cljs.core.Keyword(null,"results","results",-1134170113).cljs$core$IFn$_invoke$arity$1(f));
if(cljs.core.not.call(null,new cljs.core.Keyword(null,"multi?","multi?",-749311069).cljs$core$IFn$_invoke$arity$1(f))){
return cljs.core.first.call(null,G__65472);
} else {
return G__65472;
}
})();
...
var G__65483 = db;
var G__65484 = cljs.core.conj.call(null,cljs.core.rest.call(null,remaining),(function (){var G__65473 = cljs.core.first.call(null,remaining);
if(cljs.core.truth_(result)){
return cljs.core.update.call(null,G__65473,new cljs.core.Keyword(null,"kvps","kvps",65308317),cljs.core.assoc_BANG_,new cljs.core.Keyword(null,"attr","attr",-604132353).cljs$core$IFn$_invoke$arity$1(f),result);
} else {
return G__65473;
}
})());
...
var eids__$1 = cljs.core.into.call(null,cljs.core.PersistentVector.EMPTY,cljs.core.map.call(null,(function (p1__65485_SHARP_){
return datascript.db.entid_strict.call(null,db,p1__65485_SHARP_);
})),eids);
return datascript.pull_api.pull_pattern.call(null,db,(function (){var x__61833__auto__ = datascript.pull_api.initial_frame.call(null,pattern,eids__$1,multi_QMARK_);
...
//# sourceMappingURL=pull_api.js.map?rel=1506064175181