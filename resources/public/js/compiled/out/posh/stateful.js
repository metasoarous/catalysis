...
var len__62120__auto___67570 = arguments.length;
var i__62121__auto___67571 = (0);
while(true){
if((i__62121__auto___67571 < len__62120__auto___67570)){
args__62127__auto__.push((arguments[i__62121__auto___67571]));

var G__67572 = (i__62121__auto___67571 + (1));
i__62121__auto___67571 = G__67572;
continue;
} else {
}
break;
...
return posh.stateful.add_q.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__62128__auto__);
});
...
posh.stateful.add_q.cljs$lang$applyTo = (function (seq67568){
var G__67569 = cljs.core.first.call(null,seq67568);
var seq67568__$1 = cljs.core.next.call(null,seq67568);
return posh.stateful.add_q.cljs$core$IFn$_invoke$arity$variadic(G__67569,seq67568__$1);
});
...
return (function (p1__67573_SHARP_){
return posh.core.add_filter_tx.call(null,p1__67573_SHARP_,poshdb,tx_patterns);
});})(posh_atom))
...
var posh_atom = posh.stateful.get_posh_atom.call(null,poshdb);
return cljs.core.with_meta.call(null,new cljs.core.Keyword(null,"return","return",-1891502105).cljs$core$IFn$_invoke$arity$1(cljs.core.swap_BANG_.call(null,posh_atom,((function (posh_atom){
return (function (p1__67574_SHARP_){
return posh.core.add_filter_pull.call(null,p1__67574_SHARP_,poshdb,pull_pattern,eid);
});})(posh_atom))
)),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"posh","posh",-1205664462),posh_atom], null));
});
posh.stateful.add_filter_q = (function posh$stateful$add_filter_q(var_args){
var args__62127__auto__ = [];
var len__62120__auto___67578 = arguments.length;
var i__62121__auto___67579 = (0);
while(true){
if((i__62121__auto___67579 < len__62120__auto___67578)){
args__62127__auto__.push((arguments[i__62121__auto___67579]));

var G__67580 = (i__62121__auto___67579 + (1));
i__62121__auto___67579 = G__67580;
continue;
} else {
}
break;
...
var argseq__62128__auto__ = ((((1) < args__62127__auto__.length))?(new cljs.core.IndexedSeq(args__62127__auto__.slice((1)),(0),null)):null);
return posh.stateful.add_filter_q.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__62128__auto__);
});

posh.stateful.add_filter_q.cljs$core$IFn$_invoke$arity$variadic = (function (query,args){
var posh_atom = cljs.core.first.call(null,cljs.core.remove.call(null,cljs.core.nil_QMARK_,cljs.core.map.call(null,posh.stateful.get_posh_atom,args)));
return cljs.core.with_meta.call(null,new cljs.core.Keyword(null,"return","return",-1891502105).cljs$core$IFn$_invoke$arity$1(cljs.core.swap_BANG_.call(null,posh_atom,((function (posh_atom){
return (function (p1__67575_SHARP_){
return cljs.core.apply.call(null,posh.core.add_filter_q,p1__67575_SHARP_,query,args);
});})(posh_atom))
)),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"posh","posh",-1205664462),posh_atom], null));
});
...
posh.stateful.add_filter_q.cljs$lang$applyTo = (function (seq67576){
var G__67577 = cljs.core.first.call(null,seq67576);
var seq67576__$1 = cljs.core.next.call(null,seq67576);
return posh.stateful.add_filter_q.cljs$core$IFn$_invoke$arity$variadic(G__67577,seq67576__$1);
});
...
//# sourceMappingURL=stateful.js.map?rel=1506064177963