...
return cljs.core.reduce.call(null,(function (p__62931,entry){
var map__62932 = p__62931;
var map__62932__$1 = ((((!((map__62932 == null)))?((((map__62932.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__62932.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__62932):map__62932);
var all = map__62932__$1;
var flow = cljs.core.get.call(null,map__62932__$1,new cljs.core.Keyword(null,"flow","flow",590489032));
var exclusions = cljs.core.get.call(null,map__62932__$1,new cljs.core.Keyword(null,"exclusions","exclusions",1098729003));
...
}catch (e62934){if((e62934 instanceof Error)){
var t = e62934;
...
if(cljs.core.truth_((function (){var and__61229__auto__ = new cljs.core.Keyword(null,"success?","success?",-122854052).cljs$core$IFn$_invoke$arity$1(pred_result);
...
onyx.flow_conditions.fc_routing.route_data = (function onyx$flow_conditions$fc_routing$route_data(p__62935,result,message){
var map__62942 = p__62935;
var map__62942__$1 = ((((!((map__62942 == null)))?((((map__62942.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__62942.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__62942):map__62942);
var event = map__62942__$1;
var egress_tasks = cljs.core.get.call(null,map__62942__$1,new cljs.core.Keyword(null,"egress-tasks","egress-tasks",-609839620));
var flow_conditions = cljs.core.get.call(null,map__62942__$1,new cljs.core.Keyword("onyx.core","flow-conditions","onyx.core/flow-conditions",328485226));
...
var map__62944 = cljs.core.ex_data.call(null,message);
var map__62944__$1 = ((((!((map__62944 == null)))?((((map__62944.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__62944.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__62944):map__62944);
var exception = cljs.core.get.call(null,map__62944__$1,new cljs.core.Keyword(null,"exception","exception",-335277064));
var segment = cljs.core.get.call(null,map__62944__$1,new cljs.core.Keyword(null,"segment","segment",-964921196));
...
var map__62946 = cljs.core.ex_data.call(null,message);
var map__62946__$1 = ((((!((map__62946 == null)))?((((map__62946.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__62946.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__62946):map__62946);
var exception = cljs.core.get.call(null,map__62946__$1,new cljs.core.Keyword(null,"exception","exception",-335277064));
var segment = cljs.core.get.call(null,map__62946__$1,new cljs.core.Keyword(null,"segment","segment",-964921196));
throw onyx.flow_conditions.fc_routing.maybe_attach_segment.call(null,exception,new cljs.core.Keyword("onyx.core","task-id","onyx.core/task-id",2120719255).cljs$core$IFn$_invoke$arity$1(event),segment);
}
} else {
...
})():(function(){throw new cljs.core.Keyword(null,"exception","exception",-335277064).cljs$core$IFn$_invoke$arity$1(pred_failure)})()):(cljs.core.truth_((function (){var and__61229__auto__ = onyx.static$.util.exception_QMARK_.call(null,message);
if(cljs.core.truth_(and__61229__auto__)){
...
//# sourceMappingURL=fc_routing.js.map?rel=1506234326269