...
var vec__62905 = expr;
var seq__62906 = cljs.core.seq.call(null,vec__62905);
var first__62907 = cljs.core.first.call(null,seq__62906);
var seq__62906__$1 = cljs.core.next.call(null,seq__62906);
var op = first__62907;
var more = seq__62906__$1;
var full_expr = vec__62905;
...
return ((function (vec__62905,seq__62906,first__62907,seq__62906__$1,op,more,full_expr){
return (function (xs){
return cljs.core.every_QMARK_.call(null,cljs.core.identity,cljs.core.map.call(null,((function (vec__62905,seq__62906,first__62907,seq__62906__$1,op,more,full_expr){
return (function (token){
return onyx.flow_conditions.fc_compile.build_pred_fn.call(null,token,entry).call(null,xs);
});})(vec__62905,seq__62906,first__62907,seq__62906__$1,op,more,full_expr))
,more));
});
;})(vec__62905,seq__62906,first__62907,seq__62906__$1,op,more,full_expr))
} else {
...
return ((function (vec__62905,seq__62906,first__62907,seq__62906__$1,op,more,full_expr){
return (function (xs){
return cljs.core.some.call(null,cljs.core.identity,cljs.core.map.call(null,((function (vec__62905,seq__62906,first__62907,seq__62906__$1,op,more,full_expr){
return (function (token){
return onyx.flow_conditions.fc_compile.build_pred_fn.call(null,token,entry).call(null,xs);
});})(vec__62905,seq__62906,first__62907,seq__62906__$1,op,more,full_expr))
,more));
...
return ((function (vec__62905,seq__62906,first__62907,seq__62906__$1,op,more,full_expr){
return (function (xs){
return cljs.core.apply.call(null,onyx.static$.util.kw__GT_fn.call(null,op),cljs.core.concat.call(null,xs,cljs.core.map.call(null,((function (vec__62905,seq__62906,first__62907,seq__62906__$1,op,more,full_expr){
return (function (arg){
...
return cljs.core.map.call(null,cljs.core.second,cljs.core.filter.call(null,(function (p1__62908_SHARP_){
return cljs.core._EQ_.call(null,cljs.core.first.call(null,p1__62908_SHARP_),task);
}),workflow));
});
...
return cljs.core.filter.call(null,(function (p1__62909_SHARP_){
var or__61244__auto__ = cljs.core._EQ_.call(null,new cljs.core.Keyword("flow","from","flow/from",1812137506).cljs$core$IFn$_invoke$arity$1(p1__62909_SHARP_),task);
if(or__61244__auto__){
return or__61244__auto__;
} else {
var and__61229__auto__ = cljs.core._EQ_.call(null,new cljs.core.Keyword("flow","from","flow/from",1812137506).cljs$core$IFn$_invoke$arity$1(p1__62909_SHARP_),new cljs.core.Keyword(null,"all","all",892129742));
if(and__61229__auto__){
var or__61244__auto____$1 = cljs.core._EQ_.call(null,new cljs.core.Keyword("flow","to","flow/to",188953993).cljs$core$IFn$_invoke$arity$1(p1__62909_SHARP_),new cljs.core.Keyword(null,"all","all",892129742));
if(or__61244__auto____$1){
return or__61244__auto____$1;
} else {
return clojure.set.subset_QMARK_.call(null,cljs.core.into.call(null,cljs.core.PersistentHashSet.EMPTY,new cljs.core.Keyword("flow","to","flow/to",188953993).cljs$core$IFn$_invoke$arity$1(p1__62909_SHARP_)),cljs.core.into.call(null,cljs.core.PersistentHashSet.EMPTY,onyx.flow_conditions.fc_compile.egress_tasks.call(null,workflow,task)));
}
} else {
...
//# sourceMappingURL=fc_compile.js.map?rel=1506234326154