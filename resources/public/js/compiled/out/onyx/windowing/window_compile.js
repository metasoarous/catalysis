...
return cljs.core.filter.call(null,(function (p1__63055_SHARP_){
return cljs.core._EQ_.call(null,new cljs.core.Keyword("window","task","window/task",-720839305).cljs$core$IFn$_invoke$arity$1(p1__63055_SHARP_),task);
}),windows);
});
...
return cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.call(null,(function (p__63064){
var vec__63065 = p__63064;
var k = cljs.core.nth.call(null,vec__63065,(0),null);
var v = cljs.core.nth.call(null,vec__63065,(1),null);
...
}),cljs.core.filter.call(null,(function (p__63068){
var vec__63069 = p__63068;
var k = cljs.core.nth.call(null,vec__63069,(0),null);
var _ = cljs.core.nth.call(null,vec__63069,(1),null);
return cljs.core._EQ_.call(null,ns_str,cljs.core.namespace.call(null,k));
}),m)));
});
onyx.windowing.window_compile.resolve_trigger = (function onyx$windowing$window_compile$resolve_trigger(indices,p__63072){
var map__63075 = p__63072;
var map__63075__$1 = ((((!((map__63075 == null)))?((((map__63075.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__63075.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__63075):map__63075);
var trigger = map__63075__$1;
var sync = cljs.core.get.call(null,map__63075__$1,new cljs.core.Keyword("trigger","sync","trigger/sync",500894838));
var emit = cljs.core.get.call(null,map__63075__$1,new cljs.core.Keyword("trigger","emit","trigger/emit",-76016066));
var refinement = cljs.core.get.call(null,map__63075__$1,new cljs.core.Keyword("trigger","refinement","trigger/refinement",-1212299589));
var on = cljs.core.get.call(null,map__63075__$1,new cljs.core.Keyword("trigger","on","trigger/on",-836079968));
var id = cljs.core.get.call(null,map__63075__$1,new cljs.core.Keyword("trigger","id","trigger/id",-326368132));
var window_id = cljs.core.get.call(null,map__63075__$1,new cljs.core.Keyword("trigger","window-id","trigger/window-id",-472875377));
var state_context = cljs.core.get.call(null,map__63075__$1,new cljs.core.Keyword("trigger","state-context","trigger/state-context",-1043486338));
var pre_evictor = cljs.core.get.call(null,map__63075__$1,new cljs.core.Keyword("trigger","pre-evictor","trigger/pre-evictor",1379683944));
var post_evictor = cljs.core.get.call(null,map__63075__$1,new cljs.core.Keyword("trigger","post-evictor","trigger/post-evictor",-1705934992));
...
onyx.windowing.window_compile.build_window_executor = (function onyx$windowing$window_compile$build_window_executor(p__63078,all_triggers,state_store,indices,task_map){
var map__63081 = p__63078;
var map__63081__$1 = ((((!((map__63081 == null)))?((((map__63081.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__63081.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__63081):map__63081);
var window = map__63081__$1;
var id = cljs.core.get.call(null,map__63081__$1,new cljs.core.Keyword("window","id","window/id",-62222780));
var storage_strategy = cljs.core.get.call(null,map__63081__$1,new cljs.core.Keyword("window","storage-strategy","window/storage-strategy",-1037386492));
...
var triggers = cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.call(null,cljs.core.juxt.call(null,new cljs.core.Keyword(null,"idx","idx",1053688473),cljs.core.identity),cljs.core.map.call(null,cljs.core.partial.call(null,onyx.windowing.window_compile.resolve_trigger,indices),cljs.core.filter.call(null,((function (agg,agg_var,calls,f_init_locals,locals,window__$1,init_fn,map__63081,map__63081__$1,window,id,storage_strategy){
return (function (p1__63077_SHARP_){
return cljs.core._EQ_.call(null,new cljs.core.Keyword("window","id","window/id",-62222780).cljs$core$IFn$_invoke$arity$1(window__$1),new cljs.core.Keyword("trigger","window-id","trigger/window-id",-472875377).cljs$core$IFn$_invoke$arity$1(p1__63077_SHARP_));
});})(agg,agg_var,calls,f_init_locals,locals,window__$1,init_fn,map__63081,map__63081__$1,window,id,storage_strategy))
,all_triggers))));
...
//# sourceMappingURL=window_compile.js.map?rel=1506321310768